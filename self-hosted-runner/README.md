# marmot GitHub self hosted runner 用のサーバー構築


## 仮想マシンのデプロイ

~~~
$ mactl server create -f runner-4.yaml
~~~
...
~~~
ubuntu@ws1:~/marmot-servers/self-hosted-runner$ ansible -i inventory -m ping all
runner4 | SUCCESS => {
    "ansible_facts": {
